...
with open(r"Projects\24- Automated Birthday Wisher (Day 32)\birthdays.csv") as csv_file:
...
if bday_peeps:
    ...
    with open(f"Projects/24- Automated Birthday Wisher (Day 32)/letter_templates/{chosen}.txt") as txt_file:
